...
CFG = {
    'adecco': ('adecco.webp', 'dark', 0.25),
    'the-christmas-factory': ('the-christmas-factory.webp', 'dark', 0.35),
    'dreamstar': ('dreamstar.png', 'dark', 0.35),
    'all-about-events': ('all-about-events.png', 'light', 0.18),
    'koilakos-carpark': ('koilakos-carpark.jpg', 'knockout', 0.12),
    'easy-service-maragopoulos': ('easy-service-maragopoulos.png', 'knockout', 0.2),
    'oceansouth': ('oceansouth.jpg', 'knockout', 0.35),
}
TARGET_AREA = 26000 * 4  # equal optical area, at 2x display density

for name, (fn, mode, soft) in CFG.items():
    ...
    w, h = im.size
    s = min((TARGET_AREA / (w * h)) ** 0.5, 300 / h, 520 / w)
